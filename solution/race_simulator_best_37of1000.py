...
# Winning ultra-long HARD relief from offline search
HARD_ULTRA_LONG_RELIEF_START = 29
HARD_ULTRA_LONG_RELIEF_PER_LAP = -0.04
...
def lap_time(base_lap_time, compound, tire_age, track_temp):
    ...
    if compound == "HARD":
        ...
        # Ultra-long HARD relief: very long HARD stints stabilize a bit better
        if tire_age >= HARD_ULTRA_LONG_RELIEF_START:
